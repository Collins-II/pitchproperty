...
const solutions: SolutionItem[] = [
  {
    name: "Properties",
    description: "Sale And Rental properties",
    href: "/estates",
    active: true,
    icon: IconOne,
  },
  {
    name: "Cars",
    description: "Sale And Rental cars",
    href: "/listing-car",
    active: true,
    icon: IconThree,
  },
...
export default function DropdownTravelers() {
  ...
  return (
    <Popover className="DropdownTravelers relative flex" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
        <>
          <Popover.Button
            className={`${open ? "" : "text-opacity-90"}
                group self-center font-medium hover:text-opacity-100 focus:outline-none`}
          >

      ...
      <Popover className={`AvatarDropdown relative flex ${className}`}>
        {({ open, close }) => (
          <>
            ...
            >
              <Avatar sizeClass="w-8 h-8 sm:w-9 sm:h-9" imgUrl={currentUser?.image as string}/>
            </PopoverButton>
            <Transition
              as={Fragment}
            ...
            >
              <PopoverPanel className="absolute z-10 w-screen max-w-[260px] px-4 top-full -right-10 sm:right-0 sm:px-0">
                <div className="overflow-hidden rounded-3xl shadow-lg ring-1 ring-black ring-opacity-5">
                  <div className="relative grid grid-cols-1 gap-6 bg-white dark:bg-neutral-800 py-7 px-6">
                    <div className="flex items-center space-x-3">
                      <Avatar sizeClass="w-12 h-12" imgUrl={currentUser?.image as string} />
                    ...
                    <div className="flex items-center justify-center flex-shrink-0 text-neutral-500 dark:text-neutral-300">
                      ...
                      >
                      <path
                        d="M3 10H21M6 6H18M9 2H15M7 14H17C18.1046 14 19 14.8954 19 16V20C19 21.1046 18.1046 22 17 22H7C5.89543 22 5 21.1046 5 20V16C5 14.8954 5.89543 14 7 14Z"
                        stroke="currentColor"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"

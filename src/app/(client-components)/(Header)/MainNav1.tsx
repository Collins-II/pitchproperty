    ...
    <div className={`nc-MainNav1 relative z-10 ${className}`}>
      <div className="px-4 lg:container h-20 relative flex justify-between">
        <div className="hidden md:flex justify-start flex-1 space-x-4 sm:space-x-10">
          ...
          <p className=" h-[30px] text-xl font-semibold hidden w-full dark:block text-slate-100">KingsLand City</p>
          <p className=" h-[30px] text-xl font-semibold w-full dark:hidden text-slate-900">KingsLand City</p>
          </div>

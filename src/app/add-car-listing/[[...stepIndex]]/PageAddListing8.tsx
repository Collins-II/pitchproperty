...
import { CurrencyCode, ICar } from "@/lib/database/models/car.model";
...
const PageAddListing8: FC<PageAddListing8Props> = () => {
  ...
  useEffect(() => {
      ...
      handleDispatch("currency", currency as CurrencyCode);
  }, [currency]);
      ...
      <div className="space-y-8">
        ...
        <FormItem label="Base price">
          <div className="relative">
            ...
            <Input className="!pl-8 !pr-10" value={listingData.price} placeholder="0.00" onChange={(e) => handleDispatch("price", Number(e.target.value))}/>
        ...
        {/* ----- */}
        <FormItem label="Sale Off (Monthly discount) ">
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              <span className="text-gray-500">%</span>
            </div>
            <Input className="!pl-8 !pr-10" value={listingData?.saleOff as string} placeholder="0.00" onChange={(e) => handleDispatch("saleOff", e.target.value)  } />
            <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">

...
export const Sidebar = ({ minMaxValues, searchParams }: SidebarProps) => {
	...
	const rawMake = searchParams?.make;
    const make =
          typeof rawMake === "string"
          ? rawMake.toUpperCase() as keyof typeof VehicleModels
          : undefined;
	...
	return (
      ...
      options={Object.values(VehicleMakes).map((value) => ({
        label: value,
        value,
      }))}
    />

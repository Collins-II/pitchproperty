	...
	return (
		<header className="flex items-center justify-between h-16 px-4 bg-transparent gap-x-6">
			<div className="flex items-center flex-1">
				<Link href={routes.home as Route} className="flex items-center gap-2">
					<Image
						width={300}
						height={100}
						alt="logo"
			...
			{session ? (
				<div className="items-center md:flex gap-x-6 hidden">
					<Link href={routes.admin.dashboard as Route} className="text-foreground">
						Backoffice
					</Link>
					<SignOutForm />
				</div>
				...
				>
					<Link href={routes.favourites as Route}>
